      ...
      <div className="md:hidden space-y-4">
        {initialCategories.map((cat) => (
          <div key={cat.id} className="bg-white border border-[#efe4cd] rounded-lg p-3 shadow-sm flex gap-3 items-center relative overflow-hidden">
            <div className="shrink-0 w-16 h-16 rounded-md bg-[#f7f1e3] border border-[#efe4cd] overflow-hidden flex items-center justify-center">
               {cat.imageUrl ? (
            ...
            <div className="space-y-4 border border-[#efe4cd] p-4 rounded-lg bg-[#fdfbf7]">
                ...
                {previewUrl && (
                    <div className="mt-4">
                        ...
                        {/* CORREÇÃO: 
                           - Habilitado flex items-center justify-center no container pai.
                           - Adicionado padding (p-2).
                           - Imagem usa object-contain e max-w/max-h para não distorcer nem estourar.
                        */}
