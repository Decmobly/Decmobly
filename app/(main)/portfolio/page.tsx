...
export default async function PortfolioPage(props: PageProps) {
  ...
  console.log("🔍 Filtros recebidos:", searchParams); // Agora vai aparecer o objeto correto
  ...
  const whereClause: Prisma.ProjectWhereInput = {
    ...
    ...(categorySlug && {
      category: {
        slug: categorySlug, // Certifique-se que no banco o slug é igual ao da URL
      },
    }),
  };
          ...
          {projects.map((project: ProjectWithRelations) => (
            ...
            >
              <div className="relative h-64 overflow-hidden bg-gray-200">
                ...
                <div className="absolute top-4 left-4 bg-[#fdfbf7]/90 backdrop-blur-sm px-3 py-1 text-xs font-bold text-[#5c4d3c] uppercase tracking-wide">
