...
// 1. Importar o namespace Prisma para usar os tipos gerados
...
export async function upsertUserAction(formData: FormData, isEditingId?: string) {
  ...
  try {
    ...
    // --- UPDATE ---
      ...
      // 2. Correção: Substituído "any" pelo tipo correto do Prisma
...
export async function deleteUserAction(userIdToDelete: string) {
  ...
  // 3. Correção: Removida a variável "error" não utilizada
  } catch { 
