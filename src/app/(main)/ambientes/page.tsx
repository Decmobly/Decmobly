            ...
            {categories.map((category: Category & { _count?: { projects: number } }) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gray-200">
                  {/* 2. Substituído <img> por <Image /> com prop fill */}
                  <Image 
                  ...
                  {/* Overlay Gradiente */}
                  <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300 z-10" />
                </div>

                {/* Conteúdo do Card */}
                <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full flex flex-col justify-end h-full z-20">
